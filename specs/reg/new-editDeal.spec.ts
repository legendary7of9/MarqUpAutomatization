...
test('clientsFieldNotEditableBySa @regChecklistNewMedium @newEditDealPage', async ({ page, browserName }) => {
...
test('modelField @regChecklistNewHigh @newEditDealPage', async ({ page }) => {
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deals = new DealsPage(page);
...
test('modelFieldChanged @regChecklistNewMedium @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const newEditModel = new NewEditDealPage(page);
    const dealDetailsNameOfDeal = page.locator('h1.section__title');
    console.log('NewEditDeal Model Field');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
...
test('contractNameField @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'webkit');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    ...
    console.log('NewEditDeal Contract Name Field');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
    ...
    console.log('NewEditDeal My Company Subsidiary Field');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('myCompanySubsidiaryFieldValidation @regChecklistNewHigh @newEditDealPage', async ({ page }) => {
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    console.log('NewEditDeal My Company Subsidiary Field Validation');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('myCompanySubsidiaryFieldDropDown @regChecklistNewMedium @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    console.log('NewEditDeal My Company Subsidiary Field DropDown');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('myCompanySubsidiaryFieldSA @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'webkit');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    const myCompanySubsidiaryField = page.locator('[formcontrolname="company_name"]');
    console.log('NewEditDeal My Company Subsidiary Field SA');
    await users.SA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('nameOfTheOtherPartyField @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    console.log('NewEditDeal Name Of The Other Party Field');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('estimatedValueField @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'webkit');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    console.log('NewEditDeal Estimated Value Field');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('currencyField @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    console.log('NewEditDeal Currency Field');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('overviewField @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'webkit');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    console.log('NewEditDeal Overview Field');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
    ...
    await page.click('[formcontrolname="notes"]');
...
test('notesField @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    console.log('NewEditDeal Notes Field');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('agreementNoField @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'webkit');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const userMenu = new UserBar(page);
    ...
    console.log('NewEditDeal Agreement No Field AA');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
    ...
    await userMenu.userInfoButtonClick();
    await userMenu.signOutButtonClick();
    console.log('NewEditDeal Agreement No Field AU');
    await users.AU();
    await signIn.signInButton();
    await page.waitForURL('/clients/265');
    await page.goto('/deals?&sort=contract_name');
    ...
    await userMenu.userInfoButtonClick();
    await userMenu.signOutButtonClick();
    console.log('NewEditDeal Agreement No Field SA');
    await users.SA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('displayingLinkToExistingDealButton @regChecklistNewMedium @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const userMenu = new UserBar(page);
    ...
    console.log('NewEditDeal Displaying Link To Existing Deal Button AA');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
    ...
    await userMenu.userInfoButtonClick();
    await userMenu.signOutButtonClick();
    console.log('NewEditDeal Displaying Link To Existing Deal Button AU');
    await users.AU();
    await signIn.signInButton();
    await page.waitForURL('/clients/265');
    await page.goto('/deals?&sort=contract_name');
    ...
    await userMenu.userInfoButtonClick();
    await userMenu.signOutButtonClick();
    console.log('NewEditDeal Displaying Link To Existing Deal Button SA');
    await users.SA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('linkToExistingDealButtonValidation @regChecklistNewHigh @newEditDealPage', async ({ page }) => {
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    const newEditDeal = new NewEditDealPage(page);
    const linkTOExistingDealButtonDisabledEnabled = page.locator('.mat-dialog-container');
    console.log('NewEditDeal Link To Existing Deal Button Validation');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('linkToExistingDealPopup @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'webkit');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const userMenu = new UserBar(page);
...
test('linkToExistingDealPopupSearch @regChecklistNewMedium @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    const LinkToExistingDealPopupRow1 = page.locator('tr.mat-row.ng-star-inserted >> nth=1');
    const LinkToExistingDealPopupRow2 = page.locator('tr.mat-row.ng-star-inserted >> nth=2');
    console.log('NewEditDeal Link To Existing Deal Popup Search');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('linkToExistingDealPopupDealStatusColumns @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'webkit');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
...
test('linkToExistingDealPopupSelectButton @regChecklistNewHigh @newEditDealPage', async ({ page }) => {
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    const newEditDeal = new NewEditDealPage(page);
    ...
    console.log('NewEditDeal Link To Existing Deal Popup Select Button');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('linkToExistingDealPopupCancelButton @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    const selectedDealTitle = page.locator('.title');
    const selectedDealName = page.locator('.name');
    console.log('NewEditDeal Link To Existing Deal Popup Cancel Button');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('linkToExistingDealPopupALotOfDeals @regChecklistNewMedium @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'webkit');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    const selectedDealTitle = page.locator('.title');
    const selectedDealName = page.locator('.name');
    console.log('NewEditDeal Link To Existing Deal Popup A Lot Of Deals');
    await users.SA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('dealStatus @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
...
test('createSaveChangesButton @regChecklistNewHigh @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    ...
    console.log('NewEditDeal Create/Save Changes Button');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('cancelButton @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'webkit');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    const newEditDeal = new NewEditDealPage(page);
    console.log('NewEditDeal Cancel Button');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('modelId @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'chromium');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    const modelId = page.locator('.watermark-wrap-item >> nth=0');
    console.log('NewEditDeal Model ID');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
...
test('dealId @regChecklistNewLow @newEditDealPage', async ({ page, browserName }) => {
    test.skip(browserName === 'webkit');
    const users = new Users(page);
    const signIn = new SignInPage(page);
    const deal = new DealsPage(page);
    const dealId = page.locator('.watermark-wrap-item >> nth=1');
    console.log('NewEditDeal Deal ID');
    await users.AA();
    await signIn.signInButton();
    await page.waitForURL('/dashboard');
    await page.goto('/deals?&sort=contract_name');
